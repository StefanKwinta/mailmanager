...
public class POP3MailStoreConnectionEstablisher implements MailStoreConnectionEstablisher {
    @Override
    public Store getStore(String login, String password) {
        POP3Store emailStore = null;
        try {
            Properties properties = new Properties();
            properties.put("mail.pop3.host", HostAssigner.assignPOP3Host(login));
